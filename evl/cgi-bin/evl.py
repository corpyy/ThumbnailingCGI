...
<h2>
<h2>
<img src="images/%s" width="200" alt="Thumbnail1" title="サムネイル画像1" style="border:solid 3px #00FF41" class="appIconBig"></h2>
<h2><div align="center">OR</div></h2>
<img src="images/%s" width="200" alt="Thumbnail1" title="サムネイル画像2" style="border:solid 3px #FFFF00" class="appIconBig"></h2>
<br>
<h2>   
  <ul>
...
<div id="contents">
<h2>
<img src="images/%s" alt="Origin" title="オリジナル画像" class="appIconBig"></h2>
</div>
