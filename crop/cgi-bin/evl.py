...
<h2>スマートフォンで表示するためのサムネイル画像を作成することを想定して，プレビュー画像を参考にサムネイル画像として適切だと思う範囲をマウスで選択して下さい．</h2>
</div>
  ...
  <p>
    <div style="border: 5px ridge #FF0000; padding: 10px; width:300px;" id ="area"></div>
    <div id="area"></div>
...
print html_body % (form['img'].value, form ['thumb1'].value)
